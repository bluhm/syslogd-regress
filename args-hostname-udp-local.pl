...
our %args = (
    ...
    syslogd => {
	options => [qw(-n -h -U 127.0.0.1:514)],
    },
    server => {
	loggrep => {
	    qr/<14>2021-09-17T00:00:00Z $host client-host prog\[1234\]:/ => 1,
	    qr/<14>2021-09-17T11:11:11Z $host 1.2.3.4 prog\[1234\]:/ => 1,
	    qr/<14>2021-09-17T22:22:22Z $host - prog\[1234\]:/ => 1,
	    qr/<14>2021-09-17T33:33:33Z $host prog\[1234\]:/ => 1,
	},
    },
    file => {
	loggrep => {
